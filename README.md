...
| อีเมล | บทบาท | รหัสผ่าน |
|---|---|---|
| `manager@demo.local` | manager | `DemoPass123!` |
| `sales@demo.local` | sales | `DemoPass123!` |

บัญชีเหล่านี้มีอยู่เฉพาะในข้อมูลสาธิตที่สร้างจาก seeder เท่านั้น
