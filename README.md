...
- **อัปเดตด้วย polling ไม่ใช่ realtime** หน้าบทสนทนาดึงใหม่ทุก 10 วินาที หน้ารายการทุก 30 วินาที (A46)
  ข้อความ LINE ที่เข้ามาจึงปรากฏช้าได้สูงสุดหนึ่งรอบ — เลือกแทน WebSocket เพราะข้อมูลที่ต้อง push มีทางเดียว
  และ socket ผ่าน proxy ที่รักษา cookie ไว้ไม่ได้ ถ้าวัดได้ว่าเป็นภาระจริงค่อยย้ายไป SSE
